...
import 'package:adios_unite/screens/pageviews/chats/chat_list_screen.dart';
import 'package:adios_unite/screens/pageviews/logs/log_screen.dart';
      ...
      scaffold: Scaffold(
        ...
        body: PageView(
          children: <Widget>[
            ChatListScreen(),
            LogScreen(),
            Center(child: Text("Contacts Screen", style: TextStyle(color: Colors.orange),)),
          ],
